...
import by.anegin.vkcup21.features.news.util.StaticLayoutHelper
import by.anegin.vkcup21.news.R
import kotlin.math.max
import kotlin.math.min

internal class ExpandableTextView : View {
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        if (expandedTextHeight > collapsedTextHeight) {
            ...
            moreHeight = max(moreTextHeight, moreIconHeight).toFloat()
        ...
        val measuredHeight = when (MeasureSpec.getMode(heightMeasureSpec)) {
            MeasureSpec.AT_MOST -> min(height, minHeight.toInt())
    ...
    private fun measureText(width: Int, text: String?) {
        if (!text.isNullOrEmpty() && width > 0) {
            ...
            if (isExpandable()) {
                ...
                moreTextStaticLayout = if (moreText.isNotEmpty()) {
                ...
                moreCollapseTextStaticLayout = if (moreTextCollapse.isNotEmpty()) {
